            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-slate-700 dark:text-slate-300">{about.location}</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="card">
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-700 dark:text-slate-300">Thank you for reaching out. I'll get back to you soon.</p>
                </div>
              ) : (
                <>
                  <div className="mb-4">
