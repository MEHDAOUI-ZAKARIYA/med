...
export const skills: Skill[] = [
  ...
  {
    id: 3,
    name: "Logiciel de Bureautique // VBA ",
    level: 5,
    category: "tools",
  },
  { id: 4, name: "LaTEX", level: 3, category: "tools" },
  {
    id: 5,
    name: "React.js // TailwindCSS // Bootstrap // Django ",
    level: 4,
    category: "tools",
  },
  {
    id: 13,
    name: "Java Script // Type Script // HTTML // CSS // SQL ",
    level: 4.5,
    category: "tools",
  },
  { id: 6, name: "Java // Python ", level: 4.5, category: "tools" },
  { id: 7, name: "UI/UX Design : Figma", level: 4, category: "design" },
  { id: 8, name: "Communication", level: 4, category: "soft" },
